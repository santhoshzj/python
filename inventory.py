...
#     sql = "INSERT INTO products (product_name, category, price, quantity, supplier) VALUES (%s, %s, %s, %s, %s)"
...
# # Labels & Entries
# tk.Label(root, text="Product Name").place(x=20, y=20)
# entry_name = tk.Entry(root)
# entry_name.place(x=150, y=20)

# tk.Label(root, text="Category").place(x=20, y=60)
# entry_category = tk.Entry(root)
# entry_category.place(x=150, y=60)

# tk.Label(root, text="Price").place(x=20, y=100)
# entry_price = tk.Entry(root)
# entry_price.place(x=150, y=100)

# tk.Label(root, text="Quantity").place(x=20, y=140)
# entry_quantity = tk.Entry(root)
# entry_quantity.place(x=150, y=140)

# tk.Label(root, text="Supplier").place(x=20, y=180)
# entry_supplier = tk.Entry(root)
# entry_supplier.place(x=150, y=180)

# # Buttons
# tk.Button(root, text="Add Product", command=add_product, bg="green", fg="white").place(x=50, y=230)
# tk.Button(root, text="Delete Product", command=delete_product, bg="red", fg="white").place(x=170, y=230)
# tk.Button(root, text="Show Products", command=show_products, bg="blue", fg="white").place(x=300, y=230)
...
# tree.place(x=20, y=300, width=850, height=250)
...
# Full Professional Project with:
